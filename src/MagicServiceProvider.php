...
class MagicServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Validator::resolver(function ($translator, $data, $rules, $messages = [], $customAttributes = []) {
            return new MagicValidator($translator, $data, $rules, $messages, $customAttributes);
        });
    ...
    public function register()
    {
        ...
        app(\Faker\Generator::class)->addProvider(new MagicFakerProvider(app(\Faker\Generator::class)));
    }
